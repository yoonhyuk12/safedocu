...
export const CHECKLIST_ITEMS: Readonly<Record<string, ChecklistItem>> = {
  ...
  '산업안전보건관리비 사용내역': {
    ...
    description: '• 양식 : ' + 
      ...
      '• 시공자는 사용명세서를 매월 작성하여 보존, 감리자는 6개월 마다 1회 이상 내역 확인<br />' + 
  ...
  '안전보건교육': {
    ...
    description: 
      ...
      'target="_blank" class="text-blue-600 hover:underline">안전보건관리책임자 교육이행 시 관리감독자 교육 제외</a>'
  },  
  '위험성평가': {
    states: ['착공전', '공사중'] as const,
    costs: 'all',
